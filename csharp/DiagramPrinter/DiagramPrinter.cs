...
public class FlowchartDiagramAdapter(FlowchartDiagram? diagram)
{
    ...
    {
        return Diagram.FlowchartThumbnail();
    }
}
...
public class DiagramPrinter
{
    ...
    public static bool PrintSummary(FlowchartDiagramAdapter flowchartDiagramAdapter, string language, out string summaryText)
    {
        ...
        summary.AddTitle(flowchartDiagramAdapter.Name(), flowchartDiagramAdapter.SerialNumber());
        summary.AddHeader(flowchartDiagramAdapter.SummaryInformation());
        summary.AddImage(flowchartDiagramAdapter.FlowchartThumbnail());
